...
package com.epam.edp.stages.impl.gittag
...
class CommonApplication {
    ...
    void run(context) {
        script.dir("${context.workDir}") {
            script.withCredentials([sshUserPrivateKey(credentialsId: "${context.gerrit.credentialsId}",
                ...
                git tag -a ${context.businissAppVersion} -m 'Tag is added automatically by \
